...
from baselines.graphrnn.utils import *
from baselines.graphrnn.model import *
from baselines.graphrnn.data import *
from baselines.graphrnn.args import Args
import baselines.graphrnn.create_graphs
    ...
    for batch_idx, data in enumerate(data_loader):
        ...
        if epoch % args.epochs_log==0 and batch_idx==0: # only output first batch's statistics
            print('Epoch: {}/{}, train bce loss: {:.6f}, train kl loss: {:.6f}, graph type: {}, num_layer: {}, hidden: {}'.format(
                epoch, args.epochs,loss_bce.data, loss_kl.data, args.graph_type, args.num_layers, args.hidden_size_rnn))
        ...
        # logging
        # log_value('bce_loss_'+args.fname, loss_bce.data, epoch*args.batch_ratio+batch_idx)
        # log_value('kl_loss_' +args.fname, loss_kl.data, epoch*args.batch_ratio + batch_idx)
